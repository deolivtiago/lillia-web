      ...
      <section className="container flex flex-col px-4 py-2 md:px-8">
        <div className="grid grid-cols-1 gap-8 px-2 py-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="py-4">
              Developing innovative solutions for your business since 2025. We help companies scale
              efficiently by providing modern accounting platform and services.
            </p>
            ...
            <ul className="items-center space-y-4 py-4">
              <li className="group flex gap-2">
                <EnvelopeSimpleIcon
                  ...
                  aria-hidden
                />
                <Link to="mailto:contact@clarxlabs.com" className="group-hover:text-primary">
        ...
        <div className="border-t py-2">
          <div className="flex flex-col items-center justify-center py-2 md:flex-row md:justify-between">
            <p className="py-2 text-center text-sm">© 2025 Clarx Labs. All rights reserved.</p>
            <div className="flex flex-col gap-2 py-2 text-sm sm:flex-row">
              <Link to={AppRoutes.TermsOfUse.path} className="hover:text-primary mx-auto w-fit">
                Terms of Use
              </Link>
              <Link to={AppRoutes.PrivacyPolicy.path} className="hover:text-primary mx-auto w-fit">
                Privacy Policy
              </Link>
              <Link to={AppRoutes.Home.path} className="hover:text-primary mx-auto w-fit">
                Cookie Policy
              </Link>
            </div>
          </div>
